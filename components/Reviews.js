  ...
  return (
    <SectionWrapper>
      ...
      <div className="relative w-full">
        {data.length !== count ? (
          <div
            className="absolute bottom-0 w-full h-full bg-gradient-to-t from-white/80 dark:from-[#121212]/90 from-[50%] to-transparent
        flex justify-center items-end z-[9999]"
          >
            <button
            ...
            >
              <div className="flex gap-5">
                ...
                <div className="flex-1">
                  <h1 className="font-bold text-lag capitalize text-zinc-900 dark:text-zinc-300">
                    {rating.name}
                  </h1>
